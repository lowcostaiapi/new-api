...
// TryEscapeChannelAffinityFailure releases an affinity-bound request for one
// fallback attempt when the upstream rejected it before a response stream began.
